...
Automatically upgrade to a new version of this config and Stylelint. Install an upgrade skill with [Vercel Lab’s Agent Skills](https://github.com/vercel-labs/agent-skills):
